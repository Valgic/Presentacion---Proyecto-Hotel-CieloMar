...
public class frmPago extends javax.swing.JInternalFrame {
    ...
    private void btnnuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnnuevoActionPerformed
        ...
        String valor1 = txttotalreserva.getText();
        double Iva = 0.12;
        double otroValor = Double.parseDouble(valor1);
        double PrecioIva = otroValor * Iva;
        String numCadena= String.valueOf(PrecioIva);
        txtIva.setText(numCadena);
        
        String valor2 = txttotal_pago.getText();
        double otroValor2 = Double.parseDouble(valor2);
        double PrecioToal = PrecioIva + otroValor2;
        String numCadena2= String.valueOf(PrecioToal);
        txttotal_pago.setText(numCadena2);
        
        String valor3 = lbltotalconsumo.getText();
        double otroValor3 = Double.parseDouble(valor3);
        double subTotal = otroValor3+otroValor;
