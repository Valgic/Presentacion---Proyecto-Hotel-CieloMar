...
public class frmtrabajador extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        cbotipo_documento.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "CEDULA", "PASAPORTE", "VISA DE TRABAJO" }));
        ...
        jLabel16.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Files/Incono.png"))); // NOI18N
    ...
    private void txtnum_documentoKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtnum_documentoKeyTyped
        ...
        evt.consume();
        JOptionPane.showMessageDialog(rootPane, "Ingrese solo 15 caracteres");
        }
        char validar=evt.getKeyChar();
    ...
    private void txtsueldoKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtsueldoKeyTyped
        ...
        if(txtsueldo.getText().length()>=numero_caracteres){
        evt.consume();
        JOptionPane.showMessageDialog(rootPane, "Ingrese solo 10 caracteres");
        }
        char validar=evt.getKeyChar();
